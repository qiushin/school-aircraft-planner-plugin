#############################################################################
# Makefile for building: libqgis_hello_world.so.1.0.0
# Generated by qmake (3.1) (Qt 5.15.8)
# Project:  qgis_hello_world.pro
# Template: lib
# Command: /usr/lib/qt5/bin/qmake -o Makefile qgis_hello_world.pro
#############################################################################
...
INCPATH       = -I. -I/usr/include/qgis -I/usr/include -I/usr/include/x86_64-linux-gnu/qt5 -I/usr/include/x86_64-linux-gnu/qt5/QtWidgets -I/usr/include/x86_64-linux-gnu/qt5/QtGui -I/usr/include/x86_64-linux-gnu/qt5/QtXml -I/usr/include/x86_64-linux-gnu/qt5/QtCore -I. -I/usr/lib/x86_64-linux-gnu/qt5/mkspecs/linux-g++
...
TAR           = tar -cf
COMPRESS      = gzip -9f
DISTNAME      = qgis_hello_world1.0.0
DISTDIR = /mnt/repo/QGIS-DEV/school-plugin/.tmp/qgis_hello_world1.0.0
LINK          = g++
LFLAGS        = -Wl,-O1 -shared -Wl,-soname,libqgis_hello_world.so.1
LIBS          = $(SUBLIBS) -L/usr/lib -lqgis_core -lqgis_gui /usr/lib/x86_64-linux-gnu/libQt5Widgets.so /usr/lib/x86_64-linux-gnu/libQt5Gui.so /usr/lib/x86_64-linux-gnu/libQt5Xml.so /usr/lib/x86_64-linux-gnu/libQt5Core.so -lGL -lpthread   
AR            = ar cqs
RANLIB        = 
SED           = sed
STRIP         = strip
...
SOURCES       = src/qgis_hello_world.cpp moc_qgis_hello_world.cpp
OBJECTS       = qgis_hello_world.o \
		moc_qgis_hello_world.o
DIST          = /usr/lib/x86_64-linux-gnu/qt5/mkspecs/features/spec_pre.prf \
		...
		qgis_hello_world.pro src/qgis_hello_world.h src/qgis_hello_world.cpp
QMAKE_TARGET  = qgis_hello_world
DESTDIR       = 
TARGET        = libqgis_hello_world.so.1.0.0
TARGETA       = libqgis_hello_world.a
TARGET0       = libqgis_hello_world.so
TARGETD       = libqgis_hello_world.so.1.0.0
TARGET1       = libqgis_hello_world.so.1
TARGET2       = libqgis_hello_world.so.1.0


first: all
####### Build rules

libqgis_hello_world.so.1.0.0:  $(OBJECTS) $(SUBLIBS) $(OBJCOMP)  
...
staticlib: libqgis_hello_world.a

libqgis_hello_world.a:  $(OBJECTS) $(OBJCOMP) 
	-$(DEL_FILE) $(TARGETA) 
	$(AR) $(TARGETA) $(OBJECTS)

Makefile: qgis_hello_world.pro /usr/lib/x86_64-linux-gnu/qt5/mkspecs/linux-g++/qmake.conf /usr/lib/x86_64-linux-gnu/qt5/mkspecs/features/spec_pre.prf \
		/usr/lib/x86_64-linux-gnu/qt5/mkspecs/common/unix.conf \
		/usr/lib/x86_64-linux-gnu/qt5/mkspecs/common/linux.conf \
		/usr/lib/x86_64-linux-gnu/qt5/mkspecs/common/sanitize.conf \
		/usr/lib/x86_64-linux-gnu/qt5/mkspecs/common/gcc-base.conf \
		...
		/usr/lib/x86_64-linux-gnu/qt5/mkspecs/features/yacc.prf \
		/usr/lib/x86_64-linux-gnu/qt5/mkspecs/features/lex.prf \
		qgis_hello_world.pro
	$(QMAKE) -o Makefile qgis_hello_world.pro
...
all: Makefile libqgis_hello_world.so.1.0.0
...
distdir: FORCE
	...
	$(COPY_FILE) --parents src/qgis_hello_world.h $(DISTDIR)/
	$(COPY_FILE) --parents src/qgis_hello_world.cpp $(DISTDIR)/
...
compiler_moc_header_make_all: moc_qgis_hello_world.cpp
compiler_moc_header_clean:
	-$(DEL_FILE) moc_qgis_hello_world.cpp
moc_qgis_hello_world.cpp: src/qgis_hello_world.h \
		moc_predefs.h \
		/usr/lib/qt5/bin/moc
	/usr/lib/qt5/bin/moc $(DEFINES) --include /mnt/repo/QGIS-DEV/school-plugin/moc_predefs.h -I/usr/lib/x86_64-linux-gnu/qt5/mkspecs/linux-g++ -I/mnt/repo/QGIS-DEV/school-plugin -I/usr/include/qgis -I/usr/include -I/usr/include/x86_64-linux-gnu/qt5 -I/usr/include/x86_64-linux-gnu/qt5/QtWidgets -I/usr/include/x86_64-linux-gnu/qt5/QtGui -I/usr/include/x86_64-linux-gnu/qt5/QtXml -I/usr/include/x86_64-linux-gnu/qt5/QtCore -I/opt/adios2/2.9.0/include -I. -I/usr/include/c++/12 -I/usr/include/x86_64-linux-gnu/c++/12 -I/usr/include/c++/12/backward -I/usr/lib/gcc/x86_64-linux-gnu/12/include -I/usr/local/include -I/usr/include/x86_64-linux-gnu -I/usr/include src/qgis_hello_world.h -o moc_qgis_hello_world.cpp
...
qgis_hello_world.o: src/qgis_hello_world.cpp src/qgis_hello_world.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o qgis_hello_world.o src/qgis_hello_world.cpp

moc_qgis_hello_world.o: moc_qgis_hello_world.cpp 
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o moc_qgis_hello_world.o moc_qgis_hello_world.cpp
